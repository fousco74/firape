                ...
                <div class="col-12">
                    <div class="tgmenu__wrap">
                        <nav class="tgmenu__nav">
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('frontend/assets/img/firape/firape.png') }}" alt="Logo" style="width: 60px;"></a>
                            </div>
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('frontend/assets/img/firape/carp.png') }}" alt="Logo" style="width: 60px; margin-left: 10px;"></a>
                            </div>
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('frontend/assets/img/firape/federation1.png') }}" alt="Logo" style="width: 60px; margin-left: 10px;"></a>
                            </div>
